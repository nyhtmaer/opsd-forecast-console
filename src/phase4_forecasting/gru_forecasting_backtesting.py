...
os.makedirs(os.path.join(base_dir, 'results/phase4c_gru_de_fr_it_results'), exist_ok=True)
...
metrics_df.to_csv(os.path.join(base_dir, 'results/phase4c_gru_de_fr_it_results/metrics_comparison.csv'))
print(f" Saved metrics to results/phase4c_gru_de_fr_it_results/metrics_comparison.csv")
...
for country in countries:
    ...
    result_df.to_csv(os.path.join(base_dir, f'results/phase4c_gru_de_fr_it_results/forecast_data_{country}.csv'), index=False)
...
for idx, country in enumerate(countries):
    ...
    df_plot = pd.read_csv(os.path.join(base_dir, f'results/phase4c_gru_de_fr_it_results/forecast_data_{country}.csv'), parse_dates=['timestamp'])
...
plt.tight_layout()
plt.savefig(os.path.join(base_dir, 'results/phase4c_gru_de_fr_it_results/forecast_comparison.png'), dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig(os.path.join(base_dir, 'results/phase4c_gru_de_fr_it_results/metrics_bar_chart.png'), dpi=300, bbox_inches='tight')
...
print("\n All results saved to results/phase4c_gru_de_fr_it_results/")
